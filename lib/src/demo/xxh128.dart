...
import 'package:hashlib/hashlib.dart' show XXH128, HashDigest;
...
class XXH128Demo extends StatefulWidget {
  const XXH128Demo({super.key});

  @override
  State<StatefulWidget> createState() => _XXH128DemoState();
}

class _XXH128DemoState extends State<XXH128Demo> {
  HashDigest? digest;
  ...
  void makeDigest() {
    ...
    digest = XXH128(seed: s, secret: k).convert(bytes);
  }
